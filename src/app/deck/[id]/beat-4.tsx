  ...
  return (
    <div className="flex flex-col text-left">
      <p className="text-indigo-400 uppercase text-2xl tracking-widest pb-6">
        Thus, we decided to create
      </p>
      <div className="grid grid-cols-3">
        <div className="flex flex-col col-span-1 text-left self-center">
          ...
          <div className="flex space-x-2 items-center mb-4 opacity-60">
        ...
        <div className="flex flex-col col-span-2 self-center relative left-12">
          <div className="text-left">
            <div className="flex pb-6">
              <div className="text-[6.5rem] font-narrow font-light leading-[0.95] uppercase tracking-tighter relative right-1">
                <span className="font-semibold">
                  The Content Production Hub
                </span>
                , <br />
            ...
            {/* 
          <p className="text-slate-300 text-2xl tracking-wide pb-6">
