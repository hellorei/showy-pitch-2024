...
export default function DeckPage({ current }: { current?: boolean }) {
  ...
  const keyPoints = [
    ...
    },
    {
      ...
      trailingPhrase: "Flexible content boards tailored for production",
      ...
      summary: "For your daily social posts to your next blockbuster.",
    },
    {
      leadingWord: "Frictionless DAM",
      trailingPhrase: "Simple storage & assets sharing",
      icon: (
        <FileInput
          className="text-emerald-300 shrink-0 grow-0 mb-2"
          size={48}
