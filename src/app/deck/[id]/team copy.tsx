      ...
      <div className="grid grid-cols-2 gap-10 items-start justify-start py-4">
        ...
        <div className="flex flex-col items-start justify-start">
          ...
          <div className="text-sm text-left">
            <strong>Planned Hires:</strong>
            <br />• Lead Software Engineer.
            <br />• Lead AI Solutions Engineer.
            <br />• Head of Growth.
            <br />
            <br />
            <strong>Key Partnerships:</strong>
            <br />• Growth Hack.
            <br />• Talent Management, Culture, & Staffing.
            <br />• Non-traditional Media. (Mainstream Creators & Influencers)
            <br />• Solutions Engineering & Cloud.
            <br />
            <br />
